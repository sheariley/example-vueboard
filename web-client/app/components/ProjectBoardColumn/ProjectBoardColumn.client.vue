<template>
  <div
    class="min-w-64 max-w-80 flex flex-col items-stretch divide-y divide-neutral-400 gap-2 p-2 bg-neutral-800 border border-neutral-600 rounded-xl project-board-column"
